...
function creator(accountIds = ["acc-1"]): PortalCreator {
  return {
    ...
    relationships: [], notes: [], warmup: null, posts30d: 0, views30d: 0, likes30d: 0, comments30d: 0, shares30d: 0, bookmarks30d: 0, engagementRate: 0, trackingState: "healthy", lastActivityAt: null, source: "result",
