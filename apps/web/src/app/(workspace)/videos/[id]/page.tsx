...
export default async function VideoDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <div className="page-stack creator-profile">
    ...
    <section className="metric-grid profile-metrics">{[
      { label: "Realized CPM", value: formatCpm(video.realizedCpm) }, { label: "Views", value: video.views }, { label: "Likes", value: video.likes }, { label: "Comments", value: video.comments }, { label: "Shares", value: video.shares }, { label: "Saves", value: video.bookmarks }, { label: "Engagement", value: formatPercent(video.engagementRate) },
