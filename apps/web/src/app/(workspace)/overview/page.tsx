...
export default async function OverviewPage({ searchParams }: { searchParams: Promise<{ range?: string }> }) {
  ...
  return <div className="page-stack">
    <PageTitle eyebrow="MANAGER COMMAND CENTER" title="Result UGC" titleClassName="font-result result-ugc-title" description="The operating picture across creators, Discord, signing providers, accounts, and performance." actions={<Button variant="outline"><Link2 /> Copy this view</Button>} />
